                        ...
                        <div class="row g-0">
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <!-- Limpar Carrinho -->
                                    <div class="pt-5">
                                        <h6 class="mb-0"><a data-method="POST" class="text-body pointer" id="clearCart" onclick="remove('Pretende limpar o carrinho?', '<?= Url::toRoute('carrinho/clear', true) ?>')">Limpar
                                                Carrinho</a></h6>
                                    </div>
                                    <div class="pt-5">
