                        ...
                        <div class="row g-0">
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <!-- Limpar Carrinho -->
                                    <div class="pt-5">
                                        <h6 class="mb-0"><a data-method="POST" class="text-body pointer" id="clearCart"
                                    ...
                                    <div class="mb-5">
                                        <div class="form-outline">
                                            <div class="row">
                                                <div class="col-8">
                                                    <input type="text" id="promoCode"
                                                        class="form-control form-control-lg" style="height: 80%;" />
                                                </div>
                                                <div class="col-4">
                                                    <button id="promoCodeBtn" class="btn btn-outline-dark"
                                                        style="height: 100%;">Aplicar</button>
                                                </div>
                                            </div>
                                            <form action="<?= Url::to(['fatura/create']) ?>" method="post">
                                                ...
                                                if (!empty($carrinhos)) {
                                                ?>
                                                <button id="comprar" class="btn btn-dark btn-block btn-lg"
    ...
    $.ajax({
        ...
        success: (result) => {
            ...
            if (trigger == "button") {
                clearTimeout(timer);
                timer = setTimeout(function() {
                    var notification = alertify.notify("Código usado com sucesso.", 'success', 2,
                        function() {
