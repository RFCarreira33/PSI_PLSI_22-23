...
VALUES ('admin', '1', 1666108008), ('cliente', '2', 1666112069);
...
ALTER TABLE `cliente` ADD KEY `idUser` (`idUser`);
...
ALTER TABLE `cliente`
ADD
    CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`);
...
ALTER TABLE `fatura`
ADD
    CONSTRAINT `fatura_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idUser`);
