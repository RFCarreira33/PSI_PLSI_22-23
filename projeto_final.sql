...
('admin', 1, NULL, NULL, NULL, 1673214549, 1673214549),
('cliente', 1, NULL, NULL, NULL, 1673214549, 1673214549),
('Comprador', 2, 'Ver faturas', 'Comprador', NULL, 1673214549, 1673214549),
('CreateAdmin', 2, 'Permissão para criar uma conta de Admin', NULL, NULL, 1673214549, 1673214549),
('CreateCategoria', 2, 'Create Categoria', NULL, NULL, 1673214549, 1673214549),
('CreateFatura', 2, 'Create Fatura', NULL, NULL, 1673214549, 1673214549),
('CreateIva', 2, 'Create Iva', NULL, NULL, 1673214549, 1673214549),
('CreateLoja', 2, 'Create Loja', NULL, NULL, 1673214549, 1673214549),
('CreateMarca', 2, 'Create Marca', NULL, NULL, 1673214549, 1673214549),
('CreateProduto', 2, 'Create Produto', NULL, NULL, 1673214549, 1673214549),
('CreateStock', 2, 'Create Stock', NULL, NULL, 1673214549, 1673214549),
('DeactivateCategoria', 2, 'Deactivate Categoria', NULL, NULL, 1673214549, 1673214549),
('DeactivateFatura', 2, 'Deactivate Fatura', NULL, NULL, 1673214549, 1673214549),
('DeactivateIva', 2, 'Deactivate Iva', NULL, NULL, 1673214549, 1673214549),
('DeactivateLoja', 2, 'Deactivate Loja', NULL, NULL, 1673214549, 1673214549),
('DeactivateMarca', 2, 'Deactivate Marca', NULL, NULL, 1673214549, 1673214549),
('DeactivateProduto', 2, 'Deactivate Produto', NULL, NULL, 1673214549, 1673214549),
('DeactivateStock', 2, 'Deactivate Stock', NULL, NULL, 1673214549, 1673214549),
('DeleteCategoria', 2, 'Permission to delete Categoria', NULL, NULL, 1673214549, 1673214549),
('DeleteFatura', 2, 'Permission to delete Fatura', NULL, NULL, 1673214549, 1673214549),
('DeleteIva', 2, 'Permission to delete Iva', NULL, NULL, 1673214549, 1673214549),
('DeleteLoja', 2, 'Permission to delete Loja', NULL, NULL, 1673214549, 1673214549),
('DeleteMarca', 2, 'Permission to delete Marca', NULL, NULL, 1673214549, 1673214549),
('DeleteProduto', 2, 'Permission to delete Produto', NULL, NULL, 1673214549, 1673214549),
('DeleteStock', 2, 'Permission to delete Stock', NULL, NULL, 1673214549, 1673214549),
...
('FrontendReadFatura', 2, 'Permite ao cliente visualizar Fatura', NULL, NULL, 1673214549, 1673214549),
('FrontendReadProduto', 2, 'Permite ao cliente visualizar Produto', NULL, NULL, 1673214549, 1673214549),
('funcionario', 1, NULL, NULL, NULL, 1673214549, 1673214549),
('ReadCategoria', 2, 'Read Categoria', NULL, NULL, 1673214549, 1673214549),
('ReadEmpresa', 2, 'Alterar os dados da Empresa', NULL, NULL, 1673214549, 1673214549),
('ReadFatura', 2, 'Read Fatura', NULL, NULL, 1673214549, 1673214549),
('ReadIva', 2, 'Read Iva', NULL, NULL, 1673214549, 1673214549),
('ReadLoja', 2, 'Read Loja', NULL, NULL, 1673214549, 1673214549),
('ReadMarca', 2, 'Read Marca', NULL, NULL, 1673214549, 1673214549),
('ReadProduto', 2, 'Read Produto', NULL, NULL, 1673214549, 1673214549),
('ReadStock', 2, 'Read Stock', NULL, NULL, 1673214549, 1673214549),
('SuperiorRole', 2, NULL, 'Superior Role', NULL, 1673214549, 1673214549),
('UpdateCategoria', 2, 'Update Categoria', NULL, NULL, 1673214549, 1673214549),
('UpdateEmpresa', 2, 'Alterar os dados da Empresa', NULL, NULL, 1673214549, 1673214549),
('UpdateFatura', 2, 'Update Fatura', NULL, NULL, 1673214549, 1673214549),
('UpdateIva', 2, 'Update Iva', NULL, NULL, 1673214549, 1673214549),
('UpdateLoja', 2, 'Update Loja', NULL, NULL, 1673214549, 1673214549),
('UpdateMarca', 2, 'Update Marca', NULL, NULL, 1673214549, 1673214549),
('UpdateProduto', 2, 'Update Produto', NULL, NULL, 1673214549, 1673214549),
('UpdateStock', 2, 'Update Stock', NULL, NULL, 1673214549, 1673214549);
--
