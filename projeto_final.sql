...
VALUES ('admin', '1', 1672178424), ('cliente', '2', 1672178424), ('funcionario', '3', 1672178424);
...
VALUES (
        ...
        'FrontendReadCarrinho',
        2,
        'Permite ao cliente visualizar Carrinho',
        NULL,
        NULL,
        1673214549,
        1673214549
        ...
        'FrontendReadDados',
        2,
        'Permite ao cliente visualizar Dados',
        NULL,
        NULL,
        1673214549,
        1673214549
...
VALUES ('cliente', 'Comprador'), ('admin', 'CreateAdmin'), (
        'funcionario',
        'CreateCategoria'
    ), ('funcionario', 'CreateFatura'), ('funcionario', 'CreateIva'), ('funcionario', 'CreateLoja'), ('funcionario', 'CreateMarca'), (
        'funcionario',
        'CreateProduto'
        ...
        'funcionario',
        'DeactivateStock'
    ), ('admin', 'DeleteCategoria'), ('admin', 'DeleteFatura'), ('admin', 'DeleteIva'), ('admin', 'DeleteLoja'), ('admin', 'DeleteMarca'), ('admin', 'DeleteProduto'), ('admin', 'DeleteStock'), (
        'cliente',
        'FrontendReadCarrinho'
    ), (
        'cliente',
        ...
        'funcionario',
        'ReadCategoria'
    ), ('admin', 'ReadEmpresa'), ('funcionario', 'ReadFatura'), ('funcionario', 'ReadIva'), ('funcionario', 'ReadLoja'), ('funcionario', 'ReadMarca'), ('funcionario', 'ReadProduto'), ('funcionario', 'ReadStock'), ('funcionario', 'SuperiorRole'), (
        'funcionario',
        'UpdateCategoria'
    ), ('admin', 'UpdateEmpresa'), ('funcionario', 'UpdateFatura'), ('funcionario', 'UpdateIva'), ('funcionario', 'UpdateLoja'), ('funcionario', 'UpdateMarca'), (
        'funcionario',
        'UpdateProduto'
...
VALUES (
        'Comprador',
        0x4f3a32353a22636f6e736f6c655c6d6f64656c735c46617475726152756c65223a333a7b733a343a226e616d65223b733a393a22436f6d707261646f72223b733a393a22637265617465644174223b693a313637323137383432343b733a393a22757064617465644174223b693a313637323137383432343b7d,
        1672178424,
        1672178424
    ), (
        'Superior Role',
        ,
        1672178424,
        1672178424
    );
